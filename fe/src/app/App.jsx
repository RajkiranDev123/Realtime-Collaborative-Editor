      ...
      <main className="h-screen w-full bg-gray-950 text-white flex flex-col md:flex-row gap-4 p-4">
        ...
        <section className="w-full md:w-3/4 bg-neutral-800 rounded-lg overflow-hidden flex-1">
          <Editor
            ...
            defaultValue="// Start typing with your friends..."
            theme="vs-dark"
            onMount={handleMount}
          />
        </section>
      </main>
      <p className="text-sm bg-black text-white text-center ">
        &copy; Rajkiran Upadhyay {new Date().getFullYear()}. All rights
        reserved.
      </p>
      <p className="text-sm bg-black text-black text-center  ">.</p>
    </>
  );
}
